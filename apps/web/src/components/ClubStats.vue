...
<div role="container" v-if="isloading || (!hasError && stats)" class="flex flex-wrap  px-2 py-4 justify-center items-center h-fit">
    ...
    <div role="container" class="flex flex-wrap p-8 basis-2/2 lg:basis-1/2 h-full w-full align-middle justify-center items-center">
        <div id="donutchartnotloaded" v-if="isloading" role="container" class="flex flex-col w-full lg:w-8/12 justify-start items-center bg-base-200 dark:shadow rounded-xl shadow-lg  p-6 h-full statsright">
        ...
        <div v-else class="statsright">
            <div class="hidden dark:block bg-base-200 rounded-xl shadow-md  p-6 statsright">
                <vc-donut 
            ...
            <div class="dark:hidden bg-base-200 rounded-xl shadow-md  p-6 statsright">
                <vc-donut
                :sections="donutsections" 
                :thickness=25
                :has-legend="true" legend-placement="top"
